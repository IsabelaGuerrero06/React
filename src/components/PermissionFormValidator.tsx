                ...
                >
                    {({ handleSubmit }) => (
                        <Form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Entity */}
                            <div>
                                <label htmlFor="entity" className="block text-sm font-medium text-black dark:text-white mb-2">
                                    Entity
                                </label>
                                <Field 
                                    type="text" 
                                    ...
                                    className="w-full border border-stroke dark:border-strokedark rounded-md px-4 py-3 bg-transparent text-black dark:text-white outline-none focus:border-primary transition"
                                />
                                <ErrorMessage name="entity" component="p" className="text-red-500 text-sm mt-1" />
                            </div>
