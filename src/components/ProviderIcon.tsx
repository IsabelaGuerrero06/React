...
const ProviderIcon: React.FC<ProviderIconProps> = ({
  ...
  switch (provider) {
    case AuthProvider.GOOGLE:
      return (
        <svg style={iconStyle} className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case AuthProvider.GITHUB:
      return (
        <svg style={iconStyle} className={className} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
