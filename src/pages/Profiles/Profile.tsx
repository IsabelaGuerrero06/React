      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div className="bg-white rounded-lg shadow-lg p-10 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-8">
            Este usuario aún no ha creado su perfil. Crea uno ahora para
            comenzar.
          </p>
          <button
            onClick={() => {
              alert(
                '⚠️ No se puede crear un perfil sin un ID de usuario válido',
              );
            }}
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div className="bg-white rounded-lg shadow-lg p-10 max-w-md text-center">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 px-6 rounded-lg font-medium transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
          >
            <UserPlus size={20} />
            Crear Perfil
          </button>
